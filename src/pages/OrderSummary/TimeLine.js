...
const TimeLine = ({ info, last }) => {
  ...
  return (<div className="flex flex-col relative items-start pl-9">
    {!last && (<div className=" absolute h-full left-0 border border-[#4bbd5d] top-2 -translate-x-1/2"/>)}
    ...
    <div className=" my-7 flex flex-col items-start space-y-2">
      ...
      <div>
        <img src={process.env.PUBLIC_URL + "/img/clock.svg"} alt="" className=" mr-2 inline-block"/>
        <span>{time}</span>
      </div>
      {detail && (
