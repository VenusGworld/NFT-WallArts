...
const DropDownNavButton = ({list, title, onChangeHandle}) => {
  ...
  return (
    ...
    {<div className={` ${expanded?" -top-[500px] translate-y-0 transition-all h-full ":""} z-50 transition-all bg-[#454E61] p-4 text-white absolute -bottom-2 flex flex-col justify-start items-start translate-y-full w-[230px] left-0 ml-5`}
