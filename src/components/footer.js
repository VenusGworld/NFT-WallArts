...
import { RoundedButtonSM, RoundedButtonMD, SearchBar, RoundedTextInput } from "./Input";
        ...
        <div className="flex md:flex-row flex-col items-center justify-between py-2">
          <div className="md:w-[30%] w-[80%] flex flex-col justify-start flex-1">
            ...
            <div className="flex items-center justify-start py-2 space-x-2">
              <div className="">
                <RoundedButtonSM icon={<img src={process.env.PUBLIC_URL + "/img/twitter.svg"} className='flex w-full h-full' alt=''/>} onButtonClick={() => {}} />
              </div>
              <div className="">
              <RoundedButtonSM icon={<img src={process.env.PUBLIC_URL + "/img/facebook.svg"} className='flex w-full h-full' alt=''/>} onButtonClick={() => {}} />
              </div>
              <div className="">
              <RoundedButtonSM icon={<img src={process.env.PUBLIC_URL + "/img/instagram.svg"} className='flex w-full h-full' alt=''/>} onButtonClick={() => {}} />
              </div>
            </div>
          </div>
          <div className="flex justify-between flex-1 md:w-fit w-full">
            ...
            <div className="flex flex-col space-y-10 w-1/3">
              <div className="flex"><img src={process.env.PUBLIC_URL + "/img/location.svg"} className='flex mr-5' alt=''/>
                <span>925 Filbert Street Pennsylvania 18072</span>
              </div>
              <div className="flex"><img src={process.env.PUBLIC_URL + "/img/phone.svg"} className='flex mr-5' alt=''/><span>
                +45 34 11 44 11
              </span></div>
              <div className="flex"><img src={process.env.PUBLIC_URL + "/img/email.svg"} className='flex mr-5' alt=''/>
                <span>
                  info@mail.com
                </span>
              </div>
